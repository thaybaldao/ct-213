...
def fit_hill_climbing():
    ...
    def neighbors(theta):
        ...
        angle = 0
        while angle < 2*pi:
            theta_0 = theta[0] + cos(angle)*delta
            theta_1 = theta[1] + sin(angle)*delta
            neighbor = np.array([theta_0, theta_1])
...
def fit_simulated_annealing():
    ...
    def random_neighbor(theta):
        ...
        theta_0 = theta[0] + cos(random_angle)*delta
        theta_1 = theta[1] + sin(random_angle)*delta
